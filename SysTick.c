...
// Time delay using busy wait.
// This assumes 120 MHz system clock: 1200000
//For 14 MHz system clock: n * 1/14000000 = 10 ms, n = 140000
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(140000);  // wait 10ms 
  }
}

//For 14 MHz system clock
void SysTick_Wait10us(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(140);  // wait 10ms 
  }
}
